                ...
                while (!p1HasNoShipsLeft || !p2HasNoShipsLeft) {
                    ...
                    if (!p2HasNoShipsLeft) {
                        ...
                        if (!world2.updateShot(guess)) {
                           ...
                           //Draw Circle (This method is added by our group).
                            if(args[offset + 3].equals("greedy") || args[offset + 3].equals("monte")){
                            	
	                           for(int i=0; i<world2.shipLocations.size(); i++){
                            		
                                    for(int j=0; j<world2.shipLocations.get(i).coordinates.size(); j++){
                                			
                                    if(world2.shipLocations.get(i).coordinates.get(j).row==guess.row 
                                  
                                    && world2.shipLocations.get(i).coordinates.get(j).column==guess.column){
                                				
                                    world2.drawCircle(guess);
                    ...
                    if (!p1HasNoShipsLeft) {
                        ...
                        if (!world1.updateShot(guess)) {
                          ...
                          //Draw Circle (This method is added by our group).
                            if(args[offset + 4].equals("greedy") || args[offset + 4].equals("monte")){
                            	
	                           for(int i=0; i<world1.shipLocations.size(); i++){
                            		
                                    for(int j=0; j<world1.shipLocations.get(i).coordinates.size(); j++){
                                			
                                    if(world1.shipLocations.get(i).coordinates.get(j).row==guess.row 
                                  
                                    && world1.shipLocations.get(i).coordinates.get(j).column==guess.column){
                                				
                                    world1.drawCircle(guess);
