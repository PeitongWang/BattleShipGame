...
public class World {
    ...
    public void drawCircle(Guess guess) {
        if(!isVisual) return;
        int offset = player - 1;
        ...
        if (isHex) {
            ...
            int r = guess.row;
            int c = guess.column;
            if(guess.column==0 && guess.row!=0 && guess.row!=9){
            	  StdDraw.circle(c+d+0.5,r-0.5, 0.5);
                  StdDraw.circle(c+d+0.5,r+1.5,0.5);
                  StdDraw.circle(c+d+1.5,r+0.5,0.5);
            	
            }else if(guess.column==9 && guess.row!=9 && guess.row!=0){
            	  StdDraw.circle(c+d-0.5,r+0.5, 0.5);
            	  StdDraw.circle(c+d+0.5,r-0.5, 0.5);
                  StdDraw.circle(c+d+0.5,r+1.5,0.5);
           
            }else if(guess.column==0 && guess.row==0){
            	
            	
                  StdDraw.circle(c+d+1.5,r+0.5,0.5);
                  StdDraw.circle(c+d+0.5,r+1.5,0.5);
            }else if(guess.column==0 && guess.row==9){
            	
            	
                 StdDraw.circle(c+d+0.5,r-0.5,0.5);
                 StdDraw.circle(c+d+1.5,r+0.5,0.5);
            }else if(guess.column==9 && guess.row==0){
            	
            	 StdDraw.circle(c+d-0.5,r+0.5, 0.5);
                 StdDraw.circle(c+d+0.5,r+1.5,0.5);
            }else if(guess.column==9 && guess.row==9){
            	
                 StdDraw.circle(c+d+0.5,r-0.5, 0.5);
           	     StdDraw.circle(c+d-0.5, r+0.5, 0.5);
            	
            }else if(guess.row==0 && guess.column!=0 && guess.column!=9){
            ...
            }else if(guess.row==9 && guess.column!=0 && guess.column!=9){
            	 StdDraw.circle(c+d+0.5,r-0.5, 0.5);
                 StdDraw.circle(c+d+1.5,r+0.5,0.5);
                 StdDraw.circle(c+d-0.5,r+0.5, 0.5);
